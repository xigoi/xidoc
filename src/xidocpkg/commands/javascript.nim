...
commands jsCommands:
  proc forCmd(
      name: !String, container: !String, body: !String
  ): String {.command: "for".} =
    &"for(const {name} of {container}){{{body}}}"

  proc ifCmd(
      condition: !String, body: !String, elses: *String
  ): String {.command: "if".} =
  ...
  proc ifExprCmd(
      condition: !String, expr: !String, elses: *String
  ): String {.command: "if=".} =
  ...
  proc rangeCmd(
      name: !String, n: !String, m: ?String, r: ?String, body: !String
